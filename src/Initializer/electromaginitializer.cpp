...
void ElectromagInitializer::init1D_Ecomponent_(GridLayout const &layout, Field &Ei, uint32 iComponent)
{
...
void ElectromagInitializer::init1D_Bcomponent_(GridLayout const &layout, Field &Bi, uint32 iComponent)
{
    Point origin = layout.origin();
...
void ElectromagInitializer::init2D_Ecomponent_(GridLayout const &layout, Field &Ei, uint32 iComponent)
{
    Point origin = layout.origin();

    // ELECTRIC FIELD ----------------
    std::array<uint32, 2>   iStart{ {layout.ghostStartIndex(Ei, Direction::X),
                                     layout.ghostStartIndex(Ei, Direction::Y)}
                                  };
    std::array<uint32, 2>   iEnd  { {layout.ghostEndIndex(  Ei, Direction::X),
...
void ElectromagInitializer::init2D_Bcomponent_(GridLayout const &layout, Field &Bi, uint32 iComponent)
{
    Point origin = layout.origin();

    // MAGNETIC FIELD ----------------
    std::array<uint32, 2>   iStart{ {layout.ghostStartIndex(Bi, Direction::X),
                                     layout.ghostStartIndex(Bi, Direction::Y)}
                                  };
    std::array<uint32, 2>   iEnd  { {layout.ghostEndIndex(  Bi, Direction::X),
...
void ElectromagInitializer::init3D_Ecomponent_(GridLayout const &layout, Field &Ei, uint32 iComponent)
{
    Point origin = layout.origin();
...
void ElectromagInitializer::init3D_Bcomponent_(GridLayout const &layout, Field &Bi, uint32 iComponent)
{
    Point origin = layout.origin();
