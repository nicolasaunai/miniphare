                           ...
                           VecField const& Ve, Field const& Pe, VecField& E)
{
    ...
    uint32 iStart    = layout_.physicalStartIndex(Ex, GridLayout::directionX);
    uint32 iEnd      = layout_.physicalEndIndex  (Ex, GridLayout::directionX);
    ...
    iStart    = layout_.physicalStartIndex(Ey, GridLayout::directionX);
    iEnd      = layout_.physicalEndIndex  (Ey, GridLayout::directionX);
    ...
    iStart    = layout_.physicalStartIndex(Ez, GridLayout::directionX);
    iEnd      = layout_.physicalEndIndex  (Ez, GridLayout::directionX);
