...
public:
    ...
    SplittingStrategyFactory( std::string const & strategy,
        ...
        : strategy_{strategy}
    {
        strategyMap_["Approx1to4"]      = StrategyFunctorPtr(new FonctorApprox1to4(strategy, refineFactor, interpOrder)) ;
        strategyMap_["ApproxFujimoto"]  = StrategyFunctorPtr(new FonctorApproxFuji(strategy, refineFactor, interpOrder)) ;
        strategyMap_["splitOrder1"]     = StrategyFunctorPtr(new FonctorOrder1_RF2(strategy, refineFactor, interpOrder)) ;
        strategyMap_["splitOrder2"]     = StrategyFunctorPtr(new FonctorOrder2_RF2(strategy, refineFactor, interpOrder)) ;
        strategyMap_["splitOrder3"]     = StrategyFunctorPtr(new FonctorOrder3_RF2(strategy, refineFactor, interpOrder)) ;
        strategyMap_["splitOrder1_RFn"] = StrategyFunctorPtr(new FonctorOrder1_RFn(strategy, refineFactor, interpOrder)) ;
        strategyMap_["splitOrderN_RF2"] = StrategyFunctorPtr(new FonctorOrderN_RF2(strategy, refineFactor, interpOrder)) ;
        strategyMap_["splitOrderN_RF3"] = StrategyFunctorPtr(new FonctorOrderN_RF3(strategy, refineFactor, interpOrder)) ;
    }
