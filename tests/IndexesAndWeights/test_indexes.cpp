...
::testing::AssertionResult AreIndexListsEqual(const std::vector<uint32>& expected_indexes,
...
public:
    ...
    void SetUp()
    {
        ...
        std::string filename{"../IndexesAndWeights/indexes_testCase" + std::to_string(inputs.testId)
                             + ".txt"};
...
INSTANTIATE_TEST_CASE_P(IndexesTest, Indexes1DTest, testing::ValuesIn(getIndexesParamsFromFile()));
